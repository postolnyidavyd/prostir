...
export const bookings = [
  ...
  { room: 'Венера', user: 1, title: 'Планування спринту', dayOffset: 2, from: '13:00', to: '17:00' },
  ...
  { room: 'Венера', user: 1, title: 'Квартальні підсумки', dayOffset: -4, from: '09:30', to: '11:30' },
